...
use super::settings::setters::{
    ...
    set_max_thoughts_width, set_model_slot, set_multiline_mode, set_page_flip_on_send,
    set_pi_ask_user_question, set_pi_ask_user_question_notifications, set_pi_bash,
    set_pi_bash_command_format, set_pi_bash_run_display, set_pi_btw, set_pi_builtin_tool,
    set_pi_cache_graph, set_pi_config_skill, set_pi_eval, set_pi_eval_v2_language,
    set_pi_eval_v2_only, set_pi_goal,
    set_pi_at_search_hidden, set_pi_herdr, set_pi_keep_multi_agent, set_pi_loop, set_pi_subagents,
    set_pi_todo, set_pi_tree_file_rollback, set_pi_tree_skip_summary_prompt, set_pi_user_markdown,
    set_pi_workflows, set_progress_bar, set_prompt_cursor, set_prompt_suggestions,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::SetPiTodo(enabled) => set_pi_todo(app, enabled),
