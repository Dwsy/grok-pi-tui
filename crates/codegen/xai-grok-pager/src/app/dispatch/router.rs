...
use super::settings::setters::{
    ...
    set_pi_bash_run_display, set_pi_btw, set_pi_builtin_tool, set_pi_cache_graph, set_pi_eval,
    set_pi_eval_v2_only, set_pi_goal, set_pi_herdr, set_pi_loop, set_pi_subagents, set_pi_todo,
